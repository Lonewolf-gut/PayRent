    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Button asChild className="bg-emerald-600 hover:bg-emerald-700">
          <Link href="/dashboard/agent/promote">Find listings to promote</Link>
        </Button>
      </div>
        ...
        <Card>
          <CardContent className="space-y-4 py-12 text-center text-muted-foreground">
            ...
            <Button asChild variant="outline">
              <Link href="/dashboard/agent/promote">Browse available listings</Link>
            </Button>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="min-w-0 flex-1 space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button asChild size="sm" className="bg-emerald-600 hover:bg-emerald-700">
                      <Link href={`/dashboard/agent/promote?propertyId=${listing.id}`}>
                        Promotion links
                      </Link>
                    </Button>
                  </div>
