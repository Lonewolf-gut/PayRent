    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3">
        <Button asChild className="bg-emerald-600 hover:bg-emerald-700">
          <Link href="/dashboard/agent/promote">Promote listings</Link>
        </Button>
        <Button asChild variant="outline">
          <Link href="/dashboard/agent/earnings">View commissions</Link>
        </Button>
        <Button asChild variant="outline">
          <Link href="/dashboard/agent/applications">Review applications</Link>
        </Button>
      </div>
    </div>
  );
