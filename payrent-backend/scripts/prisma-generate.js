...
function resolveNodeModulesBase() {
  ...
  for (const base of candidates) {
    const prismaPkg = path.join(base, "node_modules", "prisma", "package.json");
...
const prismaCliCandidates = [
  path.join(nodeModulesBase, "node_modules", "prisma", "build", "index.js"),
  path.join(nodeModulesBase, "node_modules", "prisma", "build", "child.js"),
];

const prismaClientDirs = [
  path.join(nodeModulesBase, "node_modules", ".prisma", "client"),
  path.join(nodeModulesBase, "node_modules", "@prisma", "client", ".prisma", "client"),
...
const prismaVersion = (() => {
  try {
    return require(path.join(nodeModulesBase, "node_modules", "prisma", "package.json")).version;
  } catch {
    return "unknown";
  }
})();
