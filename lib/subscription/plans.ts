...
> = {
  FREE: {
    ...
    highlight: false,
    features: [
      "1 house or room listing (landlords) or assignment (agents)",
      "1 car listing or assignment",
      "1 home appliance listing or assignment",
      "3 items total across all categories",
  ...
  PRO: {
    id: "PRO",
    name: "Pro",
    tagline: "For growing landlords and agents",
    highlight: true,
    includesLabel: "Everything in Free, and:",
    features: [
      "Up to 10 houses or rooms (landlords) or assignments (agents)",
      "Up to 5 cars",
      "Up to 5 home appliances",
      "Priority listing review",
      "Agent assignment & advertising",
    ],
  },
  MAX: {
    id: "MAX",
    name: "Max",
    tagline: "Unlimited scale for landlords and agents",
    highlight: false,
